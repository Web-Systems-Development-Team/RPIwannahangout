...
<body>
    ...
    <div id='step1'>
        <video class= "center" width="400" height="400" poster="video_poster.png" autoplay><source src="polina.webm" type="video/webm"><source src="polina.mp4" type="video/mp4">Your browser does not support the video tag.</video>
