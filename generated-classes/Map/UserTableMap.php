...
class UserTableMap extends TableMap
{
     ...
     */
    const COL_PERMISSION_LEVEL = 'user.permission_level';
    ...
    {
        $this->addRelation('Event', '\\Event', RelationMap::ONE_TO_MANY, array('user_id' => 'creator_user_id', ), null, null, 'Events');
        $this->addRelation('Interest', '\\EventInterest', RelationMap::ONE_TO_MANY, array('user_id' => 'interested_user_id', ), null, null, 'Interests');
        $this->addRelation('Comment', '\\Comment', RelationMap::ONE_TO_MANY, array('user_id' => 'author_user_id', ), null, null, 'Comments');
    } // buildRelations()
    ...
    {
        return array(
            'validate' => array('rcsid_not_blank' => array ('column' => 'rcs_id','validator' => 'NotBlank',), 'fname_not_blank' => array ('column' => 'first_name','validator' => 'NotBlank',), 'lname_not_blank' => array ('column' => 'last_name','validator' => 'NotBlank',), 'email_not_blank' => array ('column' => 'email','validator' => 'NotBlank',), ),
        );
    } // getBehaviors()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.permission_level');
        }
    }
