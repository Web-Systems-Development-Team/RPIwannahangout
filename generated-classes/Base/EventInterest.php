...
*/
abstract class EventInterest implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EventInterestTableMap';
    ...
    /**
     * The value for the event_interest_id field.
     * @var        int
     */
    ...
    /**
     * Compares this with another <code>EventInterest</code> instance.  If
     * <code>obj</code> is an instance of <code>EventInterest</code>, delegates to
     * <code>equals(EventInterest)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [event_interest_id] column value.
     *
     * @return int
     */
    public function getEventInterestId()
    {
        return $this->event_interest_id;
    }
    ...
    {
        return $this->interested_user_id;
    }
     ...
     */
    public function setEventInterestId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->event_interest_id !== $v) {
            $this->event_interest_id = $v;
            $this->modifiedColumns[EventInterestTableMap::COL_EVENT_INTEREST_ID] = true;
        }
     ...
     * @return $this|\EventInterest The current object (for fluent API support)
     */
    public function setInterestedUserId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->interested_user_id !== $v) {
            $this->interested_user_id = $v;
            $this->modifiedColumns[EventInterestTableMap::COL_INTERESTED_USER_ID] = true;
        }

        if ($this->aInterested !== null && $this->aInterested->getUserId() !== $v) {
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEventInterestQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EventInterest::setDeleted()
     * @see EventInterest::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEventInterestQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventInterestTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aInterested !== null) {
                if ($this->aInterested->isModified() || $this->aInterested->isNew()) {
                    $affectedRows += $this->aInterested->save($con);
                }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[EventInterestTableMap::COL_EVENT_INTEREST_ID] = true;
        if (null !== $this->event_interest_id) {
    ...
    {
        $pos = EventInterestTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        $validPk = null !== $this->getEventInterestId();
    ...
    /**
     * Generic method to set the primary key (event_interest_id column).
     *
    ...
    {
        return null === $this->getEventInterestId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EventInterest (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EventInterest Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function setInterested(ChildUser $v = null)
    {
        if ($v === null) {
            $this->setInterestedUserId(NULL);
        } else {
            $this->setInterestedUserId($v->getUserId());
        }
     ...
     * @throws PropelException
     */
    public function getInterested(ConnectionInterface $con = null)
    {
        if ($this->aInterested === null && ($this->interested_user_id !== null)) {
            $this->aInterested = ChildUserQuery::create()->findPk($this->interested_user_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aInterested->addInterests($this);
             */
        }

        return $this->aInterested;
    }
